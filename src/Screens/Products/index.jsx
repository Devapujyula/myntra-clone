...
function Products() {
  ...
  // console.log("products", products); // to check wether fetch data using redux is working or not
    ...
    <div className="products">
      ...
      <div className="products_container">
        <Filters
          search={state.search}
          setSearch={(value) =>
            dispatcher({ type: FILTER_ENUM.SEARCH, payload: value })
          }
          price={state.price}
          setPrice={(value) =>
            dispatcher({ type: FILTER_ENUM.PRICE, payload: value })
          }
        />
